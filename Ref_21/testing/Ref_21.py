...
try:
    ...
    for i, url_url_id in enumerate(url_list):
        ...
        try:
            ...
            current_url_english = "http://www.ysxb.ac.cn/en/aps#current"
            current_url_chinese = "http://www.ysxb.ac.cn/aps#current"
            languageList = [current_url_english,current_url_english]
            response = requests.get(current_url_english, headers=headers, timeout=50,allow_redirects=True)
            ...
            while trial<5:
                try:
                    driver.get(current_url_english)
                    time.sleep(20)
